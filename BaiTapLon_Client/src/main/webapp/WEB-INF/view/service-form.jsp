...
<body>
	...
	<h1>Record</h1>
	<c:url var="saveUrl" value="/service/saveService" />
				...
				<div class="card">
					<div class="card-body">
						...
						<form:form modelAttribute="service" method="POST"
							...
							<table>
								<tr>
									<td><form:label path="tenDV">Tên Dịch Vụ:</form:label></td>
									<td><form:input path="tenDV" type="text"
											class="form-control text_input" /></td>
								</tr>
								<tr>
									<td><form:label path="donGia">Đơn giá:</form:label></td>
									<td><form:input path="donGia" type="text"
											class="form-control text_input" /></td>
								</tr>
								<tr>
									<td><form:label path="tinhTrang">Tình trạng:</form:label></td>
									<td><form:radiobutton checked="checked" path="tinhTrang"
											value="1" label="Còn dùng" /> <form:radiobutton
											path="tinhTrang" value="2" label="Không hỗ trợ" />
								</tr>
							</table>
